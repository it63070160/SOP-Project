...
public class JwtUtil {
    ...
    public String doGenerateToken(Map<String, Object> claims, String username, String type){
        ...
        if ("ACCESS".equals(type)) {
            expirationTimeLong = Long.parseLong(expirationTime) * 1000; // 1 day
//            expirationTimeLong = Long.parseLong("60") * 1000; // 1 min
        } else {
        ...
        System.out.println("Type : " + type + " Exp : " + createdDate);
        System.out.println("Type : " + type + " Exp : " + expirationDate);
        return Jwts.builder()
                .setClaims(claims)
                .setSubject(username)
